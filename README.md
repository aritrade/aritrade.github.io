...
| Certifications (Credly — Data Protection & DR) | `certifications.dataProtection`, images in `public/badges/` |
| Certifications (Credly — other) | `certifications.badges`, images in `public/badges/` |
